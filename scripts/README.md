...
0 6 * * 1-5 ~/PycharmProjects/claude-market-agents/scripts/run_earnings_trade_report.sh

# After Market Report - 1:10 PM PT (Mon-Fri)
# PT = UTC-8 (PST) or UTC-7 (PDT)
# During PST: 21:10 UTC
# During PDT: 20:10 UTC
10 13 * * 1-5 ~/PycharmProjects/claude-market-agents/scripts/run_after_market_report.sh
```
...
### Permission errors
1. Verify `settings.local.json` has `Write(~/PycharmProjects/claude-market-agents/**)`
